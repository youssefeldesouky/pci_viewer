...
#define TO_PCI_DEV(DOM,BUS,DEV,FN) ((DOM) << 24 | (BUS) << 16 | (DEV) << 11 | (FN))
#define PCI_DEV_GET_DOM(dev) (((dev) >> 24) & 0xFF)
#define PCI_DEV_GET_BUS(dev) (((dev) >> 16) & 0xFF)
#define PCI_DEV_GET_SLOT(dev) (((dev) >> 11) & 0x1F)
#define PCI_DEV_GET_FN(dev) (((dev)) & 0x07)
#define PCI_DEV_TO_OFFSET(dev) (PCI_DEV_GET_BUS(dev) *  PCIE_CFG_SPACE_SIZE * 32 + \
                                PCI_DEV_GET_SLOT(dev) * PCIE_CFG_SPACE_SIZE * 8 + \
